...
LOGGER.info("Flare is starting. | An Flare Arlgrande Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to Other Anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/Asta-silva (t.me/Chifuyu_Matsuno_Kun)")
...
app = Client("Flare", bot_token=TOKEN, api_id=API_ID, api_hash=API_HASH)
pbot = Client(
    ":memory:",
    api_id=API_ID,
    api_hash=API_HASH,
